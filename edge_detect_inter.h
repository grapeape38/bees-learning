#ifndef HALIDE_____edge_detect_inter_h
#define HALIDE_____edge_detect_inter_h
#include <stdint.h>
...
int edge_detect_inter(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int edge_detect_inter_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *edge_detect_inter_metadata() HALIDE_FUNCTION_ATTRS;
